...
class CalfListAdapter(private val onCalfListener: OnCalfListener) :
    ListAdapter<Calf, CalfViewHolder>(CalfComparator()){
...
//--------------------------------VIEW HOLDER CLASS----------------------------
class CalfViewHolder(calfView: View, onCalfListener: CalfListAdapter.OnCalfListener): RecyclerView.ViewHolder(calfView),
